  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (data.register.success) {
        ...
        // Fetch profile to get studentId
        const { data: profileData } = await getProfile({ variables: { username: input.username } });
        if (profileData && profileData.getProfile && profileData.getProfile.studentId) {
          localStorage.setItem('studentId', profileData.getProfile.studentId);
        }
