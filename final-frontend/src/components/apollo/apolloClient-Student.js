...
const httpLink = new HttpLink({
  uri: 'http://localhost:8081/query', // Ensure this matches your server's GraphQL endpoint
...
const wsLink = new GraphQLWsLink(
  createClient({
    url: 'ws://localhost:8081/query', // Ensure this matches your server's WebSocket endpoint
